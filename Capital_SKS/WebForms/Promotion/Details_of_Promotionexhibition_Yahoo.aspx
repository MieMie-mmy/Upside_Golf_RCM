<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Details_of_Promotionexhibition_Yahoo.aspx.cs" Inherits="Upside_Golf_RCM.WebForms.Promotion.Details_of_Promotionexhibition_Yahoo" %>
 ...
 <div id="CmnContents">
    ...
    <div class="setDetailBox shopCmnSet defaultSet iconSet iconYahoo exbCmnSet">
        ...
        <ul class="pageLink">
			...
			<li><a href="#data_spy_csv"><asp:Label ID="Label1" runat="server"></asp:Label></a></li>
           <%-- <li><a href="#data_add"><asp:Label ID="Label2" runat="server"></asp:Label></a></li>
              <li><a href="#data"><asp:Label ID="Label3" runat="server"></asp:Label></a></li>--%>
		...
		<table class="errorBox">
			<tbody>
			<tr>
				<td><asp:Label ID="data_spy_csv1" runat="server"></asp:Label></td><%--<asp:Label ID="lblyitemerror" runat="server" Text=""></asp:Label>--%><td><asp:TextBox ID="lblyitemerror" runat="server" TextMode="MultiLine" Enabled="false" Width="700px" /></td>
			</tr>
			
			</tbody>
		</table>
       <%-- <h2 id="data_spy-csv" runat="server"></h2>--%>
        <h2><asp:Label ID="data_spy_csv" runat="server"></asp:Label></h2>
      <%--  <h2><asp:Label ID="data_add" runat="server"></asp:Label></h2>
         <h2><asp:Label ID="data" runat="server"></asp:Label></h2>--%>
...
<asp:Label ID="Label6" runat="server" Text="path(パス)"></asp:Label>
 ...
 <th>price<span>(通常販売価格)</span></th>
     ...
     <td class="td"><asp:Label ID="lblregularprice" runat="server" 
             Text="" ></asp:Label> </td>
...
<asp:Label ID="lblRelevantLink" runat="server" Text="" 
         ></asp:Label>
</td>
...
<tr>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblTemporarypoint" runat="server" Text="" 
        ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblpointCode" runat="server" Text="" 
         ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="style3">
     ...
     <asp:Label ID="lblmetaKeyword" runat="server" Text="" 
         ></asp:Label>
    </td>
...
<th>meta-desc<span>(META description)</span></th>
 <td class="td">
     ...
     <asp:Label ID="lblmetaDescription" runat="server" Text="" 
         ></asp:Label>
    </td>
...
<th>sale-period-start<span>(販売期間（開始日）)</span></th>
 <td class="style3">
     ...
     <asp:Label ID="lblSalePeriodStart" runat="server" Text="" 
       ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblSaleperiodEnd" runat="server" Text="" 
       ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblPersonCode" runat="server" Text="" 
       ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblYahooCode" runat="server" Text="" 
        ></asp:Label>
    </td>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblProductCode" runat="server" Text="" 
        ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="td">
     ...
     <asp:Label ID="lblastk_code" runat="server" Text="" 
         ></asp:Label>
    </td>
...
<tr>
 ...
 <td class="td">
     <div  class="textarea"> <asp:TextBox ID="lblspadditional" runat="server" TextMode="MultiLine" ReadOnly="true" Height="150px" width="600px"></asp:TextBox></div>
    <%-- <asp:Label ID="lblspadditional" runat="server" Text="" 
         ></asp:Label>--%>
    </td>
...
ひと言コメント" CssClass="input"></asp:Label>
