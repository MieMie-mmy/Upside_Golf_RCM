<%@ Page Title="商品管理システム＜オプションデータインポート＞" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Yahoo_SpecName_Import.aspx.cs" Inherits="Upside_Golf_RCM.WebForms.Import.Yahoo_SpecName_Import" %>
