<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PopupCatagoryList_Test.aspx.cs" Inherits="Upside_Golf_RCM.WebForms.Item.PopupCatagoryList_Test" %>
...
<section>
    ...
    <div id="cateArea" style="height: 300px">
        ...
        <asp:TreeView ID="tvCategory" runat="server" Width="80px"
         ImageSet="Simple" NodeIndent="10" ShowLines="True"  style="float:left;"
