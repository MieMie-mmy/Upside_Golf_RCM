<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Details_of_exhibition_Rakuten.aspx.cs" Inherits="Upside_Golf_RCM.Details_of_exhibition__Rakuten_" %>
...
<%--    <asp:TemplateField HeaderText="ID" Visible="false" HeaderStyle-HorizontalAlign="Left">
    ...
    <ItemTemplate>
       ...
       <%-- <asp:TemplateField HeaderText="商品番号" HeaderStyle-HorizontalAlign="Left" Visible="False">
     <ItemTemplate>
        <asp:Label ID="Label24" runat="server" Text='<%#Eval("Item_Code")%>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>
       <asp:TemplateField HeaderText="商品名" >
     <ItemTemplate>
        <asp:Label ID="Label25" runat="server" Text='<%#Eval("Item_Name")%>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>--%>
       <asp:TemplateField HeaderText="表示先カテゴリ"  HeaderStyle-HorizontalAlign="Left">
     <ItemTemplate>
    ...
    <ItemTemplate>
        <asp:Label ID="Label64" runat="server" Text='<%#Eval("Item_Code")%>'></asp:Label>
    </ItemTemplate>
    </asp:TemplateField>--%>
