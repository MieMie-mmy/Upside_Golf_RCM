...
{
    public partial class Exhibition_List : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (Request.QueryString["list"] != null)
                    {
                     ...
                     //   DataTable dt = ehbbl.SelectAllpaging(list, null, null, null, 11, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate,0,0);
                      //  int count = Convert.ToInt32(dt.Rows[0][0].ToString());
                        ...
                        DataTable dt = ehbbl.SelectAllpaging(list, null, null, null, 1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                        int count = 0;
                        ...
                        //ddlshop.DataTextField = "Shop_Name";
                        //ddlshop.DataValueField = "Shop_Name";
                        // ddlshop.DataSource = ehb.SelectShop();
                        //ddlshop.DataBind();
                        //ddlshop.Items.Insert(0, new ListItem("--Select Shop --", ""));
                        ...
                        //    string result = "Item_Code greater than 1000!";
                        //    if (result == "Item_Code greater than 1000!")
                        //    {
                ...
                else
                {
                    ...
                    if (ctrl.Contains("lnkPaging"))
                    {
                        if (Request.QueryString["list"] != null)
                        {
                            ...
                            //gvexhibition.PageIndex = index - 1;
                            ...
                            //DataTable dt = ehb.SelectAll(list, null, null, null, 1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate);
                            else
                        ...
                        else
                        {
                            ...
                            list = Session["list"].ToString();
                            //DataTable dts = ehb.SelectAll(null, null, null, null, 5, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate);
                            ehbbl = new Exhibition_List_BL();
        ...
        protected void gvpageindex()
        {
            try
            {
                ...
                if (Request.QueryString["list"] != null)
                {
                    ...
                    DataTable dt = ehbbl.SelectAll(list, "", "", "", 1, "", "", "", "", "", "", "", "", "", "", "", "", "", "", FromDate, ToDate);
                ...
                else
                {
                    ...
                    DataTable dts = ehbbl.SelectAll(null, null, null, null, 5, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate);
        ...
        protected void pvpageindexpaging() 
        {
            try
            {
                ehbbl = new Exhibition_List_BL();
                if (Request.QueryString["list"] != null)
                {
                 ...
                 //   DataTable dt = ehbbl.SelectAllpaging(list, "", "", "", 11, "", "", "", "", "", "", "", "", "", "", "", "", "", "", FromDate, ToDate, 0, 0);

                    //int count = Convert.ToInt32(dt.Rows[0][0].ToString());

                    gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                    DataTable dt = ehbbl.SelectAllpaging(list, "", "", "", 1, "", "", "", "", "", "", "", "", "", "", "", "", "", "", FromDate, ToDate, 1, gvexhibition.PageSize);
                    int count = 0;
                    if (dt != null && dt.Rows.Count > 0)
                        count = Convert.ToInt32(dt.Rows[0]["Total_Count"].ToString());
                    gvexhibition.DataSource = dt;
                ...
                else
                {
                   ...
                   // DataTable dts = ehbbl.SelectAllpaging(null, null, null, null, 15, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 0, 0);
        ...
        protected void gvexhibition_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Detail")
            {
                ...
                else if (Convert.ToString(Mallid) == "3")
                {
                    ...
                    Response.Redirect("Details_of_exhibition_Ponpare.aspx?Shop_ID=" + shid + "&Item_ID=" + Item_ID);
                }
            ...
            try
            {
                ...
                if (Request.QueryString["list"] != null)
                {
                    if (!String.IsNullOrWhiteSpace(txtcode.Text) || ddlmall.SelectedIndex != 0 || ddlAPIcheck.SelectedIndex != 0 || ddlexbresulterror.SelectedIndex != 0 || ddlexhibitor.SelectedIndex != 0 || ddlbatchcheck.SelectedIndex != 0 || !String.IsNullOrWhiteSpace(txtproname.Text) || !String.IsNullOrWhiteSpace(txtcatinfo.Text) || !String.IsNullOrWhiteSpace(txtbrandname.Text) || !String.IsNullOrWhiteSpace(txtcompname.Text) || !String.IsNullOrWhiteSpace(txtcompetitionname.Text) || !String.IsNullOrWhiteSpace(txtclassname.Text) || !String.IsNullOrWhiteSpace(txtyear.Text) || !String.IsNullOrWhiteSpace(txtseason.Text) || !String.IsNullOrWhiteSpace(txtremark.Text) || !String.IsNullOrWhiteSpace(Request.Form[txtexdatetime1.UniqueID]) || !String.IsNullOrWhiteSpace(Request.Form[txtdatetime2.UniqueID]))
                    {
                        ...
                        {
                            gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                           // DataTable dtcount = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 11, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                //ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate, 0, 0);//Select all count
                            dt = null;
                            dt = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 1, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                        ...
                        {
                            gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                           // DataTable dtc = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 19, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                    ...
                    else
                    {
                        ...
                        {
                            gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                            //DataTable dtsc = ehbbl.SelectAllpaging(list, null, null, null, 11, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate,0,0);
                            dt = null;
                            dt = ehbbl.SelectAllpaging(list, null, null, null, 1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                            int count = 0;
                            if (dt != null && dt.Rows.Count > 0)
                                count = Convert.ToInt32(dt.Rows[0]["Total_Count"].ToString());
                        ...
                        {
                            gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                           // DataTable dtcc = ehbbl.SelectAllpaging(list, null, null, null, 19, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate,0,0);
                            dt = null;
                            dt = ehbbl.SelectAllpaging(list, null, null, null, 9, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                            int count = 0;
                            if (dt != null && dt.Rows.Count > 0)
                                count = Convert.ToInt32(dt.Rows[0]["Total_Count"].ToString());
                ...
                else
                {
                    if (!String.IsNullOrWhiteSpace(txtcode.Text) || ddlmall.SelectedIndex != 0 || ddlAPIcheck.SelectedIndex != 0 || ddlexbresulterror.SelectedIndex != 0 || ddlexhibitor.SelectedIndex != 0 || ddlbatchcheck.SelectedIndex != 0 || !String.IsNullOrWhiteSpace(txtproname.Text) || !String.IsNullOrWhiteSpace(txtcatinfo.Text) || !String.IsNullOrWhiteSpace(txtbrandname.Text) || !String.IsNullOrWhiteSpace(txtcompname.Text) || !String.IsNullOrWhiteSpace(txtcompetitionname.Text) || !String.IsNullOrWhiteSpace(txtclassname.Text) || !String.IsNullOrWhiteSpace(txtyear.Text) || !String.IsNullOrWhiteSpace(txtseason.Text) || !String.IsNullOrWhiteSpace(txtremark.Text) || !String.IsNullOrWhiteSpace(Request.Form[txtexdatetime1.UniqueID]) || !String.IsNullOrWhiteSpace(Request.Form[txtdatetime2.UniqueID]))
                    {
                        ...
                        if (ddlAPIcheck.SelectedItem.Value == "3")//for ponpare and amazone (not include)
                        {
                            ...
                            {
                                gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                              //  DataTable dtccs = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 16, null, value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                 //   ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate,0,0);
                                dt = null;
                            ...
                            else
                            {
                               ...
                               //DataTable dtccss = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 20, null, value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                                           // ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate,0,0);
                               // int counts = Convert.ToInt32(dtccss.Rows[0][0].ToString());
                                dt = null;
                               ...
                               //counts = Convert.ToInt32(dtccss.Rows[0][0].ToString());
            ...
            try
            {
                if (Request.QueryString["list"] != null)
                {
                    if (!String.IsNullOrWhiteSpace(txtcode.Text) || ddlmall.SelectedIndex != -1 || ddlAPIcheck.SelectedIndex != -1 || ddlexbresulterror.SelectedIndex != -1 || ddlexhibitor.SelectedIndex != -1 || ddlbatchcheck.SelectedIndex != -1 || !String.IsNullOrWhiteSpace(txtproname.Text) || !String.IsNullOrWhiteSpace(txtcatinfo.Text) || !String.IsNullOrWhiteSpace(txtbrandname.Text) || !String.IsNullOrWhiteSpace(txtcompname.Text) || !String.IsNullOrWhiteSpace(txtcompetitionname.Text) || !String.IsNullOrWhiteSpace(txtclassname.Text) || !String.IsNullOrWhiteSpace(txtyear.Text) || !String.IsNullOrWhiteSpace(txtseason.Text) || !String.IsNullOrWhiteSpace(txtremark.Text))
                    {
                        ...
                        DataTable dt = ehbbl.SelectAll(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 1, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                        ...
                        gvexhibition.PageIndex = e.NewPageIndex;
                        gvexhibition.DataSource = dt;
                        gvexhibition.DataBind();
                    }
                    else
                    {
                        ...
                        DataTable dt = ehbbl.SelectAll(list, null, null, null, 1, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate);
                        gvexhibition.PageIndex = e.NewPageIndex;
                        gvexhibition.DataSource = dt;
                        gvexhibition.DataBind();
                    }
        ...
        protected void ddlpage_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //        list = Session["list"].ToString();
                //        gvexhibition.PageSize = Convert.ToInt32(ddlpage.SelectedValue);
                //        DataTable dtsxc = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 11, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                //            ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate,0,0);
                //        DataTable dt = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 1, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                //            ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate, 1, gvexhibition.PageSize);
                ...
                //        list = Session["list"].ToString();
                //        gvexhibition.PageSize = Convert.ToInt32(ddlpage.SelectedValue);
                //        DataTable dtc = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 16, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                //            ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate,0,0);
                ...
                //        int count = Convert.ToInt32(dtc.Rows[0][0].ToString());
                ...
                //        list = Session["list"].ToString();
                //        gvexhibition.PageSize = Convert.ToInt32(ddlpage.SelectedValue);
                //        DataTable dtscs = ehbbl.SelectAllpaging(null, null, null, null, 15, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate,0,0);
                ...
                //        int count = Convert.ToInt32(dtscs.Rows[0][0].ToString());
        ...
        protected void gvexhibition_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    #region Strike Line
                    if (string.IsNullOrWhiteSpace(DataBinder.Eval(e.Row.DataItem, "CSV_FileName").ToString()))
                    {
                    ...
                    {
                        if (DataBinder.Eval(e.Row.DataItem, "Mall_ID").ToString().ToLower() == Convert.ToString(4) || DataBinder.Eval(e.Row.DataItem, "Mall_ID").ToString().ToLower() == Convert.ToString(5))
                        {
                            Label lblAPIcheck = (Label)e.Row.FindControl("lblAPIcheck");
                            lblAPIcheck.Text = "_";
                    ...
                    {
                        if (DataBinder.Eval(e.Row.DataItem, "Mall_ID").ToString().ToLower() == Convert.ToString(4))
                        {
                            Label lblAPIcheck = (Label)e.Row.FindControl("lblAPIcheck");
                    ...
                    else if (DataBinder.Eval(e.Row.DataItem, "ExportError_Check").ToString().ToLower() == Convert.ToString(0))
                    {
                        ...
                        //updated by hlz.
                        if (DataBinder.Eval(e.Row.DataItem, "Mall_ID").ToString().ToLower() == Convert.ToString(2) || DataBinder.Eval(e.Row.DataItem, "Mall_ID").ToString().ToLower() == Convert.ToString(4) || DataBinder.Eval(e.Row.DataItem, "Mall_ID").ToString().ToLower() == Convert.ToString(5))
                        {
                            Label lblexhiresulterror = (Label)e.Row.FindControl("lblexhiresulterror");
                ...
                if (Request.QueryString["list"] != null)
                {
                   ...
                   else
                    {
                        ...
                        if (chkitemcode.Checked)
                        {
                            ...
                            dt = ehbbl.SelectAllpaging(list, null, null, null, 21, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                        }
                        else
                        {
                            gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                           
                            dt = ehbbl.SelectAllpaging(list, null, null, null, 29, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                        }//
                    }
                ...
                else
                {
                    if (!String.IsNullOrWhiteSpace(txtcode.Text) || ddlmall.SelectedIndex != 0 || ddlAPIcheck.SelectedIndex != 0 || ddlexbresulterror.SelectedIndex != 0 || ddlexhibitor.SelectedIndex != 0 || ddlbatchcheck.SelectedIndex != 0 || !String.IsNullOrWhiteSpace(txtproname.Text) || !String.IsNullOrWhiteSpace(txtcatinfo.Text) || !String.IsNullOrWhiteSpace(txtbrandname.Text) || !String.IsNullOrWhiteSpace(txtcompname.Text) || !String.IsNullOrWhiteSpace(txtcompetitionname.Text) || !String.IsNullOrWhiteSpace(txtclassname.Text) || !String.IsNullOrWhiteSpace(txtyear.Text) || !String.IsNullOrWhiteSpace(txtseason.Text) || !String.IsNullOrWhiteSpace(txtremark.Text) || !String.IsNullOrWhiteSpace(Request.Form[txtexdatetime1.UniqueID]) || !String.IsNullOrWhiteSpace(Request.Form[txtdatetime2.UniqueID]))
                    {
                        ...
                        if (ddlAPIcheck.SelectedItem.Value == "3")//for ponpare and amazone (not include)
                        {
                            ...
                            if (chkitemcode.Checked)
                            {
                                ...
                                dt = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 26, null, value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                    ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate, 1, gvexhibition.PageSize);
                             }
                            else
                            {
                                ...
                                dt = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 30, null, value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                                            ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate, 1, gvexhibition.PageSize);
                        ...
                        else
                        {
                            ...
                            if (chkitemcode.Checked)
                            {
                                ...
                                dt = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 26, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                   ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate, 1, gvexhibition.PageSize);
                             }
                            else
                            {
                                ...
                                dt = ehbbl.SelectAllpaging(list, null, ddlmall.SelectedItem.Value, txtcode.Text.Trim(), 30, null, ddlAPIcheck.SelectedItem.Value, ddlexbresulterror.SelectedItem.Value, ddlexhibitor.SelectedItem.Value,
                                 ddlbatchcheck.SelectedItem.Value, txtproname.Text.Trim(), txtcatinfo.Text.Trim(), txtbrandname.Text.Trim(), txtcompname.Text.Trim(), txtcompetitionname.Text.Trim(), txtclassname.Text.Trim(), txtyear.Text.Trim(), txtseason.Text.Trim(), txtremark.Text.Trim(), FromDate, ToDate, 1, gvexhibition.PageSize);
                                if (ddlAPIcheck.SelectedItem.Value == "2")
                                {
                                    for (int i = 0; i < dt.Rows.Count; i++)
                    ...
                    else
                    {
                        ...
                        if (chkitemcode.Checked)
                        {
                            ...
                            dt = ehbbl.SelectAllpaging(list, null, null, null, 26, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                        }
                        else
                        {
                            gvexhibition.PageSize = int.Parse(ddlpage.SelectedValue.ToString());
                          
                            dt = ehbbl.SelectAllpaging(list, null, null, null, 30, null, null, null, null, null, null, null, null, null, null, null, null, null, null, FromDate, ToDate, 1, gvexhibition.PageSize);
                        }
                    }
