...
namespace Promotion_CSV_Export
{
    ...
    public class Change_Templates
    {
        ...
        //        }
        //        if (dt.Columns.Contains("additional1"))
        //        {
        //            dtFinal = MergeTable(ChangeTemplate(dt, shopID, "additional1"));
        //        }
        //        if (dt.Columns.Contains("additional2"))
        //        {
        //            dtFinal = MergeTable(ChangeTemplate(dt, shopID, "additional2"));
        //        }
        //        if (dt.Columns.Contains("商品説明(1)"))
        //        {
        //            dtFinal = MergeTable(ChangeTemplate(dt, shopID, "商品説明(1)"));
        //        }
        //        if (dt.Columns.Contains("商品説明(2)"))
        //        {
        ...
        //private DataTable ChangeTemplate(DataTable dt, int shopID,string columnName)
        //{
        //    DataColumnCollection columns = dt.Columns;
        //    string html = "";
        //    if (columns.Contains(columnName)) // For Rakuten
        //    {
        //        foreach (DataRow dr in dt.Rows)
        //        {
        //            //html = dt.Rows[0][columnName].ToString();
        //            html = dr[columnName].ToString();
        //            string[] templateID = GetTemplateID(html);
        //            DataTable dtTemplateDescription = GetTemplateDescription(templateID, shopID);

        //            if (dtTemplateDescription != null && dtTemplateDescription.Rows.Count > 0)
        //            {
        ...
        //                    string Value = "";
        //                    if (dtTemplateDescription.Rows.Count >= i + 1)
        //                    {
        //                        if (dtTemplateDescription.Rows[i]["Template_ID"].ToString() == Key)
        //                        {
        //                            Value = dtTemplateDescription.Rows[i]["Template_Description"].ToString();
        ...
        //                {
        //                    //html = html.Replace(replacement.Key, replacement.Value).Replace("[", "").Replace("]", "");
        //                    html = html.SafeReplace(replacement.Key, replacement.Value,true).Replace("[", "").Replace("]", "");
        //                }
        //                //dt.Rows[0][columnName] = html;
        //                dr[columnName] = html;
        //            }
        //        }
        //    }
        ...
        //private DataTable GetTemplateDescription(string[] templateID, int shopID)
        //{
        ...
        //private string[] GetTemplateID(string html)
        //{
                                ...
                                if (html.Contains("基本情報"))
                                {
                                    ...
                                    for (int t = 20; t >= 1; t--)
                                    {
                                        ...
                                        if (html.Contains("[[IF setVal=基本情報" + t + "]]"))
                                        {
                                            ...
                                            {
                                                html = html.SafeReplace("基本情報" + t, dtvalue.Rows[0]["Template" + t].ToString(), true).SafeReplace("基本情報内容" + t, dtvalue.Rows[0]["Template_Content" + t].ToString(), true);
                                ...
                                else if (html.Contains("詳細情報"))
                                {
                                    ...
                                    for (int t = 4; t >= 1; t--)
                                    {
                                        if (html.Contains("[[IF setVal=詳細情報" + t + "]]"))
                                        {
                                            ...
                                            {
                                                html = html.SafeReplace("詳細情報" + t, dtvalue.Rows[0]["Detail_Template" + t].ToString(), true).SafeReplace("詳細情報内容" + t, dtvalue.Rows[0]["Detail_Template_Content" + t].ToString(), true);
